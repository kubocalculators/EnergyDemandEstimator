...
# TODO: copied these constants in from active_cooling_v2.py - Do we need more constants? OR should these be defined in the functions?
eta = 0.8
...
with st.form("inputData", clear_on_submit=False):
    ...
    cooling_method = st.selectbox("Active Cooling Limitation", ["True Temperature and RH Setpoints","Maximum Allowed Temperature and Unlimited RH"])
    heating_method = st.selectbox("Heating Temperature Setpoint", ["True Setpoint","Minimum Allowed Temperature"])
...
# Run heating load calculation
    ...
    # TODO: Add calcaulation of HST volume including a selection of which percentile heat demand to use for the calculation
    # HST_volume = heating_v1.HST_volume(hours_of_heat_storage,)
